...
void validate_native_film_stock_contract(const FilmStockProfile& profile) {
    static const std::unordered_set<std::string> kNumericFields{
        ...
        "tone_response.raw_baseline_strength",
        "tone_response.profile_strength_toe_sensitivity",
        "tone_response.profile_strength_midtone_sensitivity",
        "tone_response.profile_strength_shoulder_sensitivity",
        "tone_response.profile_strength_rolloff_sensitivity",

...
Image rgb_to_oklab(const Image& rgb) {
    ...
    parallel_for_index(static_cast<std::ptrdiff_t>(rgb.pixel_count()), [&](std::ptrdiff_t i) {
...
Image oklab_to_rgb(const Image& oklab) {
    ...
    parallel_for_index(static_cast<std::ptrdiff_t>(oklab.pixel_count()), [&](std::ptrdiff_t i) {

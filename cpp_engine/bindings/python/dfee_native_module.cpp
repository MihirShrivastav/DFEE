...
dfee::NativePreviewRenderRequest preview_request_from_dict(PyObject* dict) {
    ...
    request.exposure_placement = dict_string(dict, "exposure_placement", "as_shot");
    request.film_exposure_ev = dict_float(dict, "film_exposure_ev");
    ...
    request.cg_shadow_hue = dict_float(dict, "cg_shadow_hue");
    request.cg_shadow_sat = dict_float(dict, "cg_shadow_sat");
    request.cg_shadow_lum = dict_float(dict, "cg_shadow_lum");
    request.cg_midtone_hue = dict_float(dict, "cg_midtone_hue");
    request.cg_midtone_sat = dict_float(dict, "cg_midtone_sat");
    request.cg_midtone_lum = dict_float(dict, "cg_midtone_lum");
    request.cg_highlight_hue = dict_float(dict, "cg_highlight_hue");
    request.cg_highlight_sat = dict_float(dict, "cg_highlight_sat");
    request.cg_highlight_lum = dict_float(dict, "cg_highlight_lum");
    request.cg_global_hue = dict_float(dict, "cg_global_hue");
    request.cg_global_sat = dict_float(dict, "cg_global_sat");
    request.cg_global_lum = dict_float(dict, "cg_global_lum");
    request.cg_balance = dict_float(dict, "cg_balance");
    request.cg_blending = dict_float(dict, "cg_blending");
    request.cg_crossbalance = dict_float(dict, "cg_crossbalance");
    ...
    request.shadow_lift = dict_float(dict, "shadow_lift", 0.0F);

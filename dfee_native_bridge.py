...
class NativePreviewRenderRequest:
    ...
    cg_shadow_hue: float = 0.0
    cg_shadow_sat: float = 0.0
    cg_shadow_lum: float = 0.0
    cg_midtone_hue: float = 0.0
    cg_midtone_sat: float = 0.0
    cg_midtone_lum: float = 0.0
    cg_highlight_hue: float = 0.0
    cg_highlight_sat: float = 0.0
    cg_highlight_lum: float = 0.0
    cg_global_hue: float = 0.0
    cg_global_sat: float = 0.0
    cg_global_lum: float = 0.0
    cg_balance: float = 0.0
    cg_blending: float = 0.0
    cg_crossbalance: float = 0.0
    clarity: float = 0.0
    texture: float = 0.0
    dehaze: float = 0.0
    sharpness: float = 0.0
